...
@DisplayName("ForgotPasswordRateLimitFilter")
class ForgotPasswordRateLimitFilterTest {
    ...
    @InjectMocks private ForgotPasswordRateLimitFilter filter;

    @Test
    @DisplayName("should pass through requests that are not forgot-password")
    void shouldPassThrough_whenNotForgotPasswordRequest() throws Exception {
    ...
    @Test
    @DisplayName("should record an attempt regardless of the response outcome")
